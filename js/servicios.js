...
const SERVICES = [
  { slug:"impresion-uv-acrilico", nombre:"IMPRESIÓN UV ACRÍLICO", imagen:"Impresion UV Acrilico.png", tipoModal:"completo",
    aplicaciones:["Impresión sobre rígidos","Acrílico y plásticos","Señalamientos","Figuras decorativas"] },
  { slug:"impresion-uv-trovicel", nombre:"IMPRESIÓN UV TROVICEL", imagen:"Impresion UV Trovicel.png", tipoModal:"completo",
    aplicaciones:["Impresión sobre rígidos","Coroplast y trovicel","Señalamientos"] },
  { slug:"impresion-uv-coroplast", nombre:"IMPRESIÓN UV COROPLAST", imagen:"Impresion UV coroplast.png", tipoModal:"completo",
    aplicaciones:["Impresión sobre rígidos","Coroplast y trovicel","Señalamientos"] },
  ...
  { slug:"impresion-uv-mdf", nombre:"IMPRESIÓN UV MDF", imagen:"Impresion UV MDF.png", tipoModal:"completo",
    aplicaciones:["Maderas","Figuras decorativas","Señalamientos"] },
  { slug:"impresion-uv-vitropiso", nombre:"IMPRESIÓN UV VITROPISO", imagen:"Impresion UV Vitropiso.png", tipoModal:"completo",
    aplicaciones:["Vidrio y azulejos","Pisos decorativos","Señalamientos"] },
  { slug:"impresion-dtf-textil", nombre:"IMPRESIÓN DTF TEXTIL", imagen:"Impresion DTF Textil.png", tipoModal:"completo",
  ...
  { slug:"impresion-dtf-uv", nombre:"IMPRESIÓN DTF UV", imagen:"Impresion DTF UV.png", tipoModal:"completo",
  ...
  { slug:"corte-laser", nombre:"CORTE LÁSER", imagen:"Corte Laser.png", tipoModal:"completo",
  ...
  { slug:"grabado-laser", nombre:"GRABADO LÁSER", imagen:"Grabado Laser.png", tipoModal:"completo",
  ...
  { slug:"bordado", nombre:"BORDADO", imagen:"Bordado.png", tipoModal:"completo",
  ...
  { slug:"serigrafia", nombre:"SERIGRAFÍA", imagen:"Serigrafia.png", tipoModal:"breve",
